  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-ink dark:bg-dark-bg dark:text-dark-ink">
      <header className="flex items-center justify-between px-6 py-4">
        <span className="font-mono text-[10px] uppercase tracking-widest text-muted">play</span>
        <h1 className="font-mono text-2xl font-semibold uppercase tracking-widest">Oware</h1>
        <div className="flex items-center gap-2">
          <button
            onClick={() => navigate("/stats?scope=all")}
            className="border border-line px-3 py-1 font-mono text-[10px] uppercase tracking-wider text-muted transition-colors hover:border-ink hover:text-ink dark:border-dark-line dark:hover:border-dark-muted dark:hover:text-dark-ink"
          >
            stats
          </button>
          <button
